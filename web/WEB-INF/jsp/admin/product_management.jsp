...
<head>
    ...
    <style>
        /* ... (styles remain largely the same, but image specific styles for thumbnail can be removed if desired) ... */
        ...
        /* .admin-table img.product-thumbnail { ... } // This style can be removed */
        ...
        .admin-table .actions .btn-edit { background-color: #ffc107; color: #212529; border:none; display: inline-block; }
    ...
    <div class="admin-content-container">
        ...
        <% if (products != null && !products.isEmpty()) { %>
            <table class="admin-table">
                <thead>
                    <tr>
                        <%-- <th style="width: 80px;">Image</th> --%> <%-- REMOVED Image column header --%>
                ...
                <tbody>
                    <% for (Product p : products) { %>
                        <tr>
                            <%-- Image td REMOVED
                            <td>
                                <img src="..." alt="<%= p.getName() %>" class="product-thumbnail">
                            </td>
                            --%>
                            ...
                            <td class="actions">
                                ...
                                <form action="${pageContext.request.contextPath}/AdminProductServlet" method="post" style="display:inline;">
                                    ...
                                    <button type="submit" class="btn-delete"
                                            onclick="return confirmDelete('<%= p.getProductId() %>', '<%= p.getName().replace("'", "\\'") %>');">Delete</button>
                                </form>
                            </td>
                        </tr>
                    <% } %>
